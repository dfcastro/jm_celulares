...
@push('styles')
    ...
    <style>
        .card-header h5, .card-title { font-weight: 500; }
        .section-title { margin-bottom: 0.5rem; font-weight: bold; color: #495057; }
        .dl-horizontal dt { float: left; width: 200px; font-weight: normal; color: #6c757d; }
        .dl-horizontal dd { margin-left: 220px; margin-bottom: .3rem; }
        .item-list { list-style: none; padding-left: 0; }
        .item-list li { border-bottom: 1px solid #eee; padding: 8px 0; }
        .item-list li:last-child { border-bottom: none; }
        .total-line { border-top: 2px solid #dee2e6; padding-top: 0.5rem; margin-top: 0.5rem; }
        .badge.status-orc { font-size: 1.1em; }
            ...
            <div class="row">
                <div class="col-md-7">
                    ...
                    <dl class="dl-horizontal">
                        ...
                        <dd><pre>{{ $orcamento->problema_relatado_cliente }}</pre></dd>
                    </dl>
                </div>
                <div class="col-md-5">
