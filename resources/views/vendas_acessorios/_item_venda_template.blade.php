...
- $itensEstoque: A lista de todos os itens de estoque para preencher o dropdown <select>
    --}}
    ...
    <div class="row item-venda align-items-center"> {{-- Classe item-venda para identificar a linha via JS --}}
        <div class="col-md-4 mb-3">
            ...
            <input type="text" class="form-control item-estoque-autocomplete" placeholder="Buscar Peça..." {{--
                Pré-preenche com o nome da peça se houver old input (precisamos que o controlador passe 'nome_peca' no
                $itemData se houver erro) --}}
            ...
            @enderror
            {{-- Opcional: Exibir erro de estoque customizado associado a este item (mais avançado) --}}
            {{-- @if(isset($errors) && $errors->has('itens') && is_array($errors->get('itens'))) --}}
            {{-- @foreach($errors->get('itens') as $errorItem) --}}
            {{-- @if(str_contains($errorItem, "ID {$itemData['estoque_id']}")) --}}
            {{-- <div class="text-danger">{{ $errorItem }}</div> --}}
            {{-- @break --}}
            {{-- @endif --}}
            {{-- @endforeach --}}
            {{-- @endif --}}
        ...
        <div class="col-md-2 mb-3">
            ...
            <input type="number" class="form-control item-quantidade" name="itens[{{ $index }}][quantidade]" {{--
                Preenche com old input ou padrão 1 --}}
        ...
        <div class="col-md-2 mb-3"> {{-- Ajustado Largura --}}
            ...
            <input type="number" step="0.01" class="form-control item-preco-unitario"
                name="itens[{{ $index }}][preco_unitario_venda]" {{-- Preenche com old input ou padrão 0.00, formatando
                corretamente --}}
        ...
        <div class="col-md-2 mb-3"> {{-- Nova Coluna --}}
